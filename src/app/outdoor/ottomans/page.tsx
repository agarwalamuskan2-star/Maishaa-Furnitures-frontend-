...
const OutdoorOttomansCollection = () => {
    useEffect(() => {
        document.title = "Luxury Outdoor Ottomans & Stools | Maishaa";
    }, []);

    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            name: "Isles Woven Outdoor Ottoman",
            price: "18,500",
            emi: "1,541",
            tag: "READY TO SHIP",
            description: "Weatherproof synthetic rattan weave with quick-dry foam cushioning.",
            bestSeller: true,
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Outdoor Ottomans</span>
                    </nav>
                </div>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Outdoor Ottomans</h1>
...
export default OutdoorOttomansCollection;
