...
const OutdoorChairsBenchesCollection = () => {
    useEffect(() => {
        document.title = "Luxury Outdoor Chairs & Benches | Maishaa";
    }, []);

    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            name: "Lydia Outdoor Dining Chair",
            price: "18,500",
            emi: "1,541",
            tag: "READY TO SHIP",
            description: "Ergonomic outdoor seating crafted from premium teak and weather-resistant rope weave.",
            bestSeller: true,
            image: "https://images.unsplash.com/photo-1592078615290-033ee584e267?q=80&w=1000",
            type: "Chairs"
        },
        {
            name: "Isles Garden Bench",
            price: "42,000",
            emi: "3,500",
            tag: "MADE TO ORDER",
            description: "A timeless garden bench with a contemporary twist, featuring a curved teak backrest.",
            bestSeller: false,
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Outdoor Chairs & Benches</span>
                    </nav>
                </div>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Outdoor Chairs & Benches</h1>
...
export default OutdoorChairsBenchesCollection;
