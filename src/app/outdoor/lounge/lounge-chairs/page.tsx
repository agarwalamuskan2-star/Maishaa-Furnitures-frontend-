...
/**
 * OUTDOOR LOUNGE CHAIRS COLLECTION PAGE
 */

const OutdoorLoungeChairsPage = () => {
    useEffect(() => {
        document.title = "Buy Modern Outdoor Lounge Chairs | Maishaa";
    }, []);
    ...
    const products = [
        ...
        {
            name: "Coastal Teak Lounge Chair",
            price: "89,500",
            tag: "SOLD OUT",
            status: "SOLD OUT",
        ...
        {
            name: "Minimalist Metal Lounge Chair",
            price: "58,900",
            emi: "6179",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Lounge Chairs</span>
                    </nav>
                </div>
                    ...
                    <div className="max-w-[1920px] mx-auto flex flex-col lg:flex-row gap-12">
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-6">
                                <p className="text-gray-900 font-medium tracking-[0.1em] text-sm uppercase">8 Results</p>
...
export default OutdoorLoungeChairsPage;
