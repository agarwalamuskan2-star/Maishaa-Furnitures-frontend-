...
const BuffetsCollection = () => {
    useEffect(() => {
        document.title = "Luxury Buffet & Sideboard Consoles | Maishaa";
    }, []);
    ...
    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            ...
            emi: "12,466",
            tag: "MADE TO ORDER",
            description: "A mid-century inspired sideboard with sleek oak finish and precision-cut door details.",
            bestSeller: true,
        ...
        },
        {
            ...
            emi: "15,200",
            tag: "MADE TO ORDER",
            description: "Traditional Indian chiseling meets contemporary form in this statement buffet piece.",
            bestSeller: false,
        ...
        },
        {
            ...
            emi: "17,295",
            tag: "MADE TO ORDER",
            description: "A solid presence in any dining or living room, featuring architectural lines and premium walnut finish.",
            bestSeller: true,
    ...
    const availableTypes = [
        ...
        { label: "Buffets", value: "Buffets", count: products.filter(p => p.type === "Buffets").length },
    ].filter(t => t.count > 0);
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Buffet & Sideboard Consoles</span>
                    </nav>
                </div>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Buffet & Sideboard Consoles</h1>
                ...
                <section className="py-24 px-4 bg-[#fbfbfb] border-t border-gray-100">
                    <div className="max-w-4xl mx-auto text-center space-y-8">
                        ...
                        >
                            Our collection of buffets and sideboards offers the perfect balance of concealed storage and refined surface area. From chiseled textures to monolithic walnut forms, each piece is designed to anchor your dining space with artisanal grace.
                        </motion.p>
                    </div>
                </section>
            </main>
...
export default BuffetsCollection;
