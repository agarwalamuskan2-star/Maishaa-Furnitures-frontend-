...
const StorageDrawersCollection = () => {
    useEffect(() => {
        document.title = "Luxury Chest of Drawers | Maishaa";
    }, []);
    ...
    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            ...
            emi: "7,133",
            tag: "READY TO SHIP",
            description: "Ample storage meet sophisticated design. Features fluted textures and elegant hardware for a modern finish.",
            bestSeller: true,
            image: "https://images.unsplash.com/photo-1616486029423-aaa4789e8c9a?q=80&w=1000",
            type: "Tallboy"
        },
        {
            name: "Minimalist Oak Chest",
            price: "62,000",
            emi: "5,166",
            tag: "MADE TO ORDER",
            description: "Clean lines and natural oak textures make this chest a versatile addition to any storage space.",
            bestSeller: false,
            image: "https://images.unsplash.com/photo-1594026112284-02bb6f3352fe?q=80&w=1000",
            type: "Low Chest"
        },
        {
            name: "Voss Slatted Chest of Drawers",
            price: "92,500",
            emi: "7,708",
            tag: "MADE TO ORDER",
            description: "Part of the Voss series, this storage unit features signature slatted door aesthetics and high-capacity drawers.",
            bestSeller: true,
    ...
    const availableTypes = [
        { label: "Tallboy", value: "Tallboy", count: products.filter(p => p.type === "Tallboy").length },
        { label: "Low Chest", value: "Low Chest", count: products.filter(p => p.type === "Low Chest").length },
    ].filter(t => t.count > 0);
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Chest of Drawers</span>
                    </nav>
                </div>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Chest of Drawers</h1>
...
export default StorageDrawersCollection;
