...
const ModularStorageCollection = () => {
    useEffect(() => {
        document.title = "Luxury Modular Storage Units | Maishaa";
    }, []);

    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            name: "Lydia Modular Cube Unit",
            price: "22,500",
            emi: "1,875",
            tag: "READY TO SHIP",
            description: "Stackable storage modules that grow with your needs. Ideal for books, decor, or vinyl collections.",
            bestSeller: true,
            image: "https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?q=80&w=1000",
            type: "Cube Units"
        },
        {
            name: "Voss Modular Shelving System",
            price: "45,000",
            emi: "3,750",
            tag: "MADE TO ORDER",
            description: "Versatile wall-mounted or floor-standing shelving that adapts to any space configuration.",
            bestSeller: false,
            image: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?q=80&w=1000",
            type: "Shelving Systems"
        }
    ];
    ...
    const availableTypes = [
        { label: "Cube Units", value: "Cube Units", count: products.filter(p => p.type === "Cube Units").length },
        { label: "Shelving Systems", value: "Shelving Systems", count: products.filter(p => p.type === "Shelving Systems").length },
    ].filter(t => t.count > 0);
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Modular Storage Units</span>
                    </nav>
                </div>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Modular Storage Units</h1>
...
export default ModularStorageCollection;
