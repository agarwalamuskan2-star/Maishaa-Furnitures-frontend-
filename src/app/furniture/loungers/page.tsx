...
const LoungersCollection = () => {
    useEffect(() => {
        document.title = "Luxury Loungers & Recliners | Maishaa";
    }, []);

    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            name: "Lydia Daydaze Lounger",
            price: "56,000",
            emi: "4,666",
            tag: "MADE TO ORDER",
            description: "Ultimate relaxation. A wide-profile lounger with plush cushioning and high-performance fabric.",
            bestSeller: true,
            image: "https://images.unsplash.com/photo-1540518614846-7eded433c457?q=80&w=1000",
            type: "Loungers"
        },
        {
            name: "Veda Sculptural Lounger",
            price: "78,500",
            emi: "6,541",
            tag: "MADE TO ORDER",
            description: "An artistic lounging silhouette that offers deep-seated comfort and architectural presence.",
            bestSeller: false,
    ...
    const availableTypes = [
        { label: "Loungers", value: "Loungers", count: products.filter(p => p.type === "Loungers").length },
        { label: "Chaise Lounge", value: "Chaise Lounge", count: products.filter(p => p.type === "Chaise Lounge").length },
    ].filter(t => t.count > 0);
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Loungers</span>
                    </nav>
                </div>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Loungers</h1>
...
export default LoungersCollection;
