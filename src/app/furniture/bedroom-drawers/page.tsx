...
const BedroomDrawersCollection = () => {
    useEffect(() => {
        document.title = "Designer Bedroom Chest of Drawers | Maishaa";
    }, []);

    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            name: "Lydia Chest of 6 Drawers - Bedroom Edition",
            price: "85,600",
            emi: "7,133",
            tag: "READY TO SHIP",
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Bedroom Chest of Drawers</h1>
...
export default BedroomDrawersCollection;
