                    ...
                    <div className="max-w-[1920px] mx-auto flex flex-col lg:flex-row gap-12">
                                ...
                                <div className="space-y-10">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Media Unit (10)</span>
                                            </li>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                <div className="w-4 h-4 border border-gray-300 rounded-sm"></div>
                                                <span className="text-[14px]">M (3)</span>
                                            </li>
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                <div className="w-4 h-4 border border-gray-300 rounded-sm"></div>
                                                <span className="text-[14px]">S (2)</span>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            {["10% and above", "30% and above"].map((disc) => (
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-6">
                                <p className="text-gray-900 font-medium tracking-[0.1em] text-sm uppercase">11 Results</p>
