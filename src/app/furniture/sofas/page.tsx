...
const SofasCollection = () => {
    useEffect(() => {
        document.title = "Sofas | Maishaa";
    }, []);

    const products: Product[] = [
        { name: "Modern Velvet 3-Seater Sofa", price: "1,45,000", originalPrice: "1,81,250", discount: "20% Off", emi: "12,083", tag: "MADE TO ORDER", bestSeller: true, image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=1000", type: "3-Seater Sofas" },
        { name: "Leather Chesterfield Sofa", price: "2,10,000", originalPrice: "2,62,500", discount: "20% Off", emi: "17,500", tag: "MADE TO ORDER", bestSeller: true, image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?q=80&w=1000", type: "3-Seater Sofas" },
        { name: "Scandinavian Fabric Sofa", price: "98,000", originalPrice: "1,22,500", discount: "20% Off", emi: "8,167", tag: "READY TO SHIP", bestSeller: false, image: "https://images.unsplash.com/photo-1540574163026-643ea20ade25?q=80&w=1000", type: "2-Seater Sofas" },
        { name: "Mid-Century Modern Sofa", price: "1,25,000", originalPrice: "1,56,250", discount: "20% Off", emi: "10,417", tag: "MADE TO ORDER", bestSeller: true, image: "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?q=80&w=1000", type: "Loveseats" },
        { name: "Tufted Linen Sofa", price: "1,35,000", originalPrice: "1,68,750", discount: "20% Off", emi: "11,250", tag: "MADE TO ORDER", bestSeller: false, image: "https://images.unsplash.com/photo-1550254478-ead40cc54513?q=80&w=1000", type: "Sofa Beds" },
        { name: "Contemporary L-Shape Sofa", price: "1,85,000", originalPrice: "2,31,250", discount: "20% Off", emi: "15,417", tag: "MADE TO ORDER", bestSeller: true, image: "https://images.unsplash.com/photo-1567016432779-094069958ad5?q=80&w=1000", type: "3-Seater Sofas" },
    ];
    ...
    const availableTypes = [
        { label: "3-Seater Sofas", value: "3-Seater Sofas", count: products.filter(p => p.type === "3-Seater Sofas").length },
        { label: "2-Seater Sofas", value: "2-Seater Sofas", count: products.filter(p => p.type === "2-Seater Sofas").length },
        { label: "Loveseats", value: "Loveseats", count: products.filter(p => p.type === "Loveseats").length },
        { label: "Sofa Beds", value: "Sofa Beds", count: products.filter(p => p.type === "Sofa Beds").length }
    ].filter(t => t.count > 0);
