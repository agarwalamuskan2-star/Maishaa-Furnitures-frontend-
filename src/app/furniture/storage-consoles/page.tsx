...
const StorageConsolesCollection = () => {
    useEffect(() => {
        document.title = "Designer Console Tables | Maishaa";
    }, []);

    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            name: "Lydia Contemporary Console",
            price: "42,500",
            emi: "3,542",
            tag: "READY TO SHIP",
            description: "A sleek entry or living room console with a minimal oak frame and marble top.",
            bestSeller: true,
            image: "https://images.unsplash.com/photo-1533090481720-856c6e3c1fdc?q=80&w=1000",
            type: "Modern"
        },
        {
            name: "Monolith Foyer Console",
            price: "58,000",
            emi: "4,833",
            tag: "MADE TO ORDER",
            description: "Commanding foyer piece with thick walnut profiles and hidden drawer storage.",
            bestSeller: false,
    ...
    const availableTypes = [
        { label: "Modern", value: "Modern", count: products.filter(p => p.type === "Modern").length },
        { label: "Minimalist", value: "Minimalist", count: products.filter(p => p.type === "Minimalist").length },
    ].filter(t => t.count > 0);
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Console Tables</span>
                    </nav>
                </div>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Console Tables</h1>
...
export default StorageConsolesCollection;
