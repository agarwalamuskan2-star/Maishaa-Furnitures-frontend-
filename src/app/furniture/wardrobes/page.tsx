...
const WardrobesCollection = () => {
    useEffect(() => {
        document.title = "Luxury Wardrobes & Armoires | Maishaa";
    }, []);

    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            name: "Lydia 4-Door Wardrobe",
            price: "1,85,000",
            emi: "15,416",
            tag: "MADE TO ORDER",
            description: "A commanding bedroom staple with ample hanging space and integrated drawers. Features fluted glass panels.",
            bestSeller: true,
            image: "https://images.unsplash.com/photo-1595428774223-ef52624120d2?q=80&w=1000",
            type: "Wardrobes"
        },
        {
            name: "Voss Slatted Armoire",
            price: "1,45,000",
            emi: "12,083",
            tag: "MADE TO ORDER",
            description: "Signature Voss slatted aesthetic in a vertical silhouette, providing sophisticated storage for clothing or linens.",
            bestSeller: false,
    ...
    const availableTypes = [
        ...
        { label: "Armoires", value: "Armoires", count: products.filter(p => p.type === "Armoires").length },
    ].filter(t => t.count > 0);
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Armoires | Wardrobes</span>
                    </nav>
                </div>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Armoires | Wardrobes</h1>
...
export default WardrobesCollection;
