...
const DiningBenchesCollection = () => {
    useEffect(() => {
        document.title = "Luxury Dining Benches | Maishaa";
    }, []);

    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            name: "Ebba 2.0 Upholstered Bench",
            price: "42,000",
            originalPrice: "56,000",
            discountLabel: "25% Off",
            emi: "3,500",
            tag: "MADE TO ORDER",
            description: "A statement dining bench with a curved profile and luxury velvet upholstery, perfect for communal dining.",
            bestSeller: true,
        ...
        },
        {
            ...
            emi: "3,208",
            tag: "MADE TO ORDER",
            description: "Minimalist solid wood bench from the Sinag collection, featuring surgical precision in every joint.",
            bestSeller: false,
        ...
        },
        {
            ...
            emi: "2,666",
            tag: "READY TO SHIP",
            description: "A versatile dining bench with button-tufted upholstery and tapered dark oak legs.",
            bestSeller: true,
    ...
    const availableTypes = [
        { label: "Dining Benches", value: "Dining Benches", count: products.filter(p => p.type === "Dining Benches").length },
    ].filter(t => t.count > 0);
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Dining Benches</span>
                    </nav>
                </div>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Dining Benches</h1>
                ...
                <section className="py-24 px-4 max-w-5xl mx-auto text-center border-t border-gray-100">
                    ...
                    >
                        ...
                        <p className="text-gray-600 leading-relaxed text-lg md:text-xl font-light font-serif italic text-center">
                            Our dining benches redefine communal seating. Combining sculptural wooden forms with plush upholstery, they offer a relaxed alternative to traditional chairs without compromising on elegance.
                        </p>
                    </motion.div>
                </section>
            </main>
...
export default DiningBenchesCollection;
