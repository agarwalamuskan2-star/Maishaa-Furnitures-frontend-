...
const BarCabinetsCollection = () => {
    useEffect(() => {
        document.title = "Luxury Bar Cabinets & Sideboards | Maishaa";
    }, []);

    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            name: "Lydia Bar Cabinet",
            price: "1,15,560",
            originalPrice: "1,28,400",
            discountLabel: "10% Off",
            emi: "12,115",
            tag: "MADE TO ORDER",
            description: "An architectural statement piece featuring fluted glass doors and a sophisticated dark oak finish.",
            bestSeller: true,
            image: "https://images.unsplash.com/photo-1594026112284-02bb6f3352fe?q=80&w=1000",
            type: "Bar Cabinets"
        },
        {
            name: "Regal Walnut Bar Cabinet",
            price: "1,45,000",
            originalPrice: "1,61,000",
            discountLabel: "10% Off",
            emi: "15,200",
            tag: "MADE TO ORDER",
            description: "Commanding presence with rich walnut veneer and polished brass hardware for a touch of classic luxury.",
            bestSeller: false,
            image: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?q=80&w=1000",
            type: "Bar Cabinets"
        },
        {
            name: "Chevron Oak Bar Unit",
            price: "89,000",
    ...
    const availableTypes = [
        { label: "Bar Cabinets", value: "Bar Cabinets", count: products.filter(p => p.type === "Bar Cabinets").length },
        { label: "Bar Units", value: "Bar Units", count: products.filter(p => p.type === "Bar Units").length },
    ].filter(t => t.count > 0);
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Bar Cabinets</span>
                    </nav>
                </div>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Bar Cabinets</h1>
                ...
                <section className="py-24 px-4 max-w-5xl mx-auto text-center border-t border-gray-100">
                    ...
                    >
                        ...
                        <p className="text-gray-600 leading-relaxed text-lg md:text-xl font-light font-serif italic text-center">
                            A bar cabinet is the ultimate expression of hospitality. Our collection blends functional wine and spirits storage with sculptural elegance, ensuring your hosting essentials are presented with as much style as they are served with.
                        </p>
                    </motion.div>
                </section>
            </main>
...
export default BarCabinetsCollection;
