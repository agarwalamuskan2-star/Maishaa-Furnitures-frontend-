...
const SectionalsCollection = () => {
    const products = [
        { name: "Modern U-Shape Sectional", price: "2,45,000", originalPrice: "3,06,250", discount: "20% Off", emi: "20,417", tag: "MADE TO ORDER", bestSeller: true, image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=1000" },
        ...
        { name: "Corner Sectional with Chaise", price: "2,10,000", originalPrice: "2,62,500", discount: "20% Off", emi: "17,500", tag: "MADE TO ORDER", bestSeller: false, image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?q=80&w=1000" },
        ...
        { name: "Modular 5-Piece Sectional", price: "2,25,000", originalPrice: "2,81,250", discount: "20% Off", emi: "18,750", tag: "READY TO SHIP", bestSeller: false, image: "https://images.unsplash.com/photo-1550254478-ead40cc54513?q=80&w=1000" },
        { name: "Reversible Chaise Sectional", price: "1,85,000", originalPrice: "2,31,250", discount: "20% Off", emi: "15,417", tag: "MADE TO ORDER", bestSeller: true, image: "https://images.unsplash.com/photo-1567016432779-094069958ad5?q=80&w=1000" },
    ];
                                ...
                                <div className="space-y-10">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            {["L-Shape (10)", "U-Shape (6)", "Modular (8)", "With Chaise (7)"].map((type) => (
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            {["Velvet (9)", "Leather (7)", "Linen (6)", "Fabric (12)"].map((material) => (
