...
const ChairsLoveseatsCollection = () => {
    useEffect(() => {
        document.title = "Luxury Chairs & Loveseats | Maishaa";
    }, []);
    ...
    const products: (Product & { description?: string, bestSeller?: boolean, emi?: string, discountLabel?: string })[] = [
        {
            ...
            emi: "2,708",
            tag: "READY TO SHIP",
            description: "A sculptural seat with high-density foam and curated fabric upholstery.",
            bestSeller: true,
            image: "https://images.unsplash.com/photo-1592078615290-033ee584e267?q=80&w=1000",
            type: "Chairs"
        },
        {
            name: "Monroe 2-Seater Loveseat",
            price: "72,000",
            emi: "6,000",
            tag: "MADE TO ORDER",
            description: "Charming 2-seater with tufted backrest and tapered wooden legs, ideal for cozy corners.",
            bestSeller: false,
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Chairs & Loveseats</span>
                    </nav>
                </div>
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-6">
                                <div className="space-y-2">
                                    <h1 className="text-2xl font-serif font-medium uppercase tracking-wider">Chairs & Loveseats</h1>
...
export default ChairsLoveseatsCollection;
