...
const SofasSectionalsCollection = () => {
    ...
    const products = [
        ...
        { name: "Modern U-Shape Sectional", price: "2,45,000", originalPrice: "3,06,250", discount: "20% Off", emi: "20,417", tag: "MADE TO ORDER", bestSeller: true, image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=1000" }, // Reused image as placeholder, you might want distinct ones
