                            ...
                            >
                                ...
                                <div className="p-6 flex flex-col flex-1">
                                    <div className="mb-4">
                                        ...
                                        <h4 className="text-[16px] font-medium text-gray-900 group-hover:text-amber-900 transition-colors leading-snug font-serif">
                                            {product.name}
                                        </h4>
                                    </div>
                                    ...
                                    <div className="mt-auto space-y-2">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[13px] text-orange-600 font-bold">{product.discount} Off</span>
                                        </div>
