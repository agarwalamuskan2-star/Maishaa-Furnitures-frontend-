...
const ManhattanCollection = () => {
    const products = [
        ...
        { name: "Broadway Media Console", price: "52,000", originalPrice: "65,000", discount: "20% Off", emi: "4622", tag: "MADE TO ORDER", bestSeller: true, image: "https://images.unsplash.com/photo-1558211583-d28f97575689?q=80&w=1000" },
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                        ...
                        <div className="overflow-hidden">
                            <motion.h1
                                ...
                                className="text-5xl md:text-9xl font-serif text-gray-900 leading-tight tracking-tight uppercase"
                            >
                                MANHATTAN
                            </motion.h1>
                        </div>
