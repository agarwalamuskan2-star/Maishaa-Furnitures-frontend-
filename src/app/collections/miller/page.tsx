...
const MillerLoungeSeries = () => {
    const products = [
        ...
        { name: "Miller Diwan", price: "1,25,000", originalPrice: "1,56,250", discount: "20% Off", emi: "11111", tag: "MADE TO ORDER", bestSeller: false, image: "https://images.unsplash.com/photo-1593170511425-22d7744a5092?q=80&w=800" },
        ...
        { name: "Miller Floor Lamp", price: "18,000", originalPrice: "22,500", discount: "20% Off", emi: "1600", tag: "READY TO SHIP", bestSeller: false, image: "https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?q=80&w=800" },
