...
const FosterLiving = () => {
    const products = [
        { name: "Foster Chaise Sectional Sofa - Taupe", price: "3,15,000", originalPrice: "3,93,750", discount: "20% Off", emi: "27999", tag: "MADE TO ORDER", bestSeller: true, image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?q=80&w=800" },
        { name: "Foster Apartment Four Seater Sofa with Storage", price: "2,45,000", originalPrice: "3,06,250", discount: "20% Off", emi: "21777", tag: "MADE TO ORDER", bestSeller: false, image: "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?q=80&w=800" },
        ...
        { name: "Modern Grille TV Unit", price: "1,12,000", originalPrice: "1,40,000", discount: "20% Off", emi: "9955", tag: "MADE TO ORDER", bestSeller: true, image: "https://images.unsplash.com/photo-1558211583-d28f97575689?q=80&w=800" },
        ...
        { name: "Foster Round End Table", price: "18,000", originalPrice: "22,500", discount: "20% Off", emi: "1600", tag: "READY TO SHIP", bestSeller: false, image: "https://images.unsplash.com/photo-1533090161767-e6ffed986c88?q=80&w=800" },
        { name: "Architectural Pillar Stand", price: "24,000", originalPrice: "30,000", discount: "20% Off", emi: "2133", tag: "MADE TO ORDER", bestSeller: false, image: "https://images.unsplash.com/photo-1506439773649-6e0eb8cfb237?q=80&w=800" },
            ...
            <main className="flex-1">
                ...
                <section className="relative w-full h-[60vh] md:h-[80vh] overflow-hidden">
                    ...
                    <div className="absolute inset-x-0 bottom-24 flex flex-col items-center text-white text-center px-4">
                        <span className="text-sm md:text-xl font-light tracking-[0.5em] uppercase mb-4 opacity-90">structure & comfort</span>
                        <h1 className="text-4xl md:text-8xl font-serif mb-6 leading-tight uppercase font-bold tracking-tighter">
                            FOSTER LIVING
                        </h1>
                        <p className="text-xs md:text-lg font-light tracking-[0.4em] uppercase opacity-80 max-w-2xl">
                            Where architectural clarity meets everyday comfort
                        </p>
                    </div>
                </section>
                ...
                <section className="py-28 px-4 max-w-5xl mx-auto text-center space-y-12">
                    <div className="space-y-6">
                        <h3 className="text-4xl md:text-6xl font-serif text-gray-900 font-light">The Foster Living Series</h3>
                    ...
                    <p className="text-gray-500 leading-relaxed text-lg md:text-xl font-light max-w-4xl mx-auto">
                        Foster Living skillfully merges traditional and contemporary aesthetics, emphasizing clarity, craftsmanship, and timeless appeal.
                        The collection features stunning fluted wooden frames—a nod to classic architectural details—perfectly balanced with sleek metal legs
                        for a modern edge. Designed for the discerning urban home, every piece in the series invites you to experience
                        a harmonious blend of sophisticated structure and unparalleled comfort.
                    </p>
                </section>
                ...
                <section className="bg-[#1a1a1a] text-white overflow-hidden">
                    <div className="max-w-[1920px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 min-h-[600px]">
                        <div className="lg:col-span-5 p-12 md:p-24 flex flex-col justify-center space-y-10">
                            <span className="text-xs font-bold tracking-[0.5em] text-gray-400 uppercase">SIGNATURE PIECE</span>
                            <div className="space-y-8">
                                <h2 className="text-4xl md:text-7xl font-serif leading-tight">
                                    Foster Chaise Sectional
                                </h2>
                                <p className="text-gray-400 leading-relaxed text-lg md:text-xl font-light">
                                    Redefining the modern living room, the Foster Chaise Sectional combines expansive seating with
                                    meticulous fluted details. Its architectural framework provides a sense of permanence while
                                    yielding to plush, luxurious comfort.
                                </p>
                            </div>
                            <button className="w-fit px-12 py-5 border border-white text-white text-xs uppercase tracking-[0.3em] hover:bg-white hover:text-black transition-all duration-500">
                                DISCOVER MORE
                            </button>
                        </div>
                ...
                <section className="py-32 px-4 sm:px-8 md:px-16 lg:px-20">
                    <div className="text-center mb-24 space-y-4">
                        ...
                        <p className="text-gray-400 font-light tracking-[0.2em] uppercase text-xs">
                            Discover the architectural elegance of the Foster series
                        </p>
                    </div>
                        ...
                        {products.map((product, idx) => (
                            ...
                            >
                                <div className="relative aspect-[4/5] bg-[#f5f5f5] overflow-hidden mb-8">
                                    ...
                                    {product.bestSeller && (
                                        <div className="absolute top-0 left-0 bg-black text-white text-[10px] px-5 py-2 font-bold tracking-[0.2em] uppercase">
                                            BEST SELLER
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="space-y-4 px-1">
                                    ...
                                    <h4 className="text-[17px] text-gray-900 font-medium group-hover:text-gray-600 transition-colors line-clamp-2 min-h-[51px]">
                                        {product.name}
                                    </h4>
                                    <div className="pt-2 border-t border-gray-100">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <p className="text-[13px] text-blue-600 font-semibold tracking-wide">{product.discount}</p>
                                        </div>
                                        <p className="text-[12px] text-gray-500 font-light italic mt-2 opacity-80">
