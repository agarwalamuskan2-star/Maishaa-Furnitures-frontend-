...
/**
 * DECORATIVE MIRRORS COLLECTION PAGE
 * 
...
const DecorativeMirrorsCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Decorative Mirrors Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Mandala Sunburst Decorative Mirror",
            price: "24,800",
        ...
        {
            name: "Art Deco Geometric Mirror",
            price: "18,400",
        ...
        {
            name: "Bohemian Rattan Decorative Mirror",
            price: "12,120",
        ...
        {
            name: "Luxe Fragmented Wall Mirror",
            price: "29,900",
            emi: "2645",
            tag: "MADE TO ORDER",
        ...
        {
            name: "Asymmetrical Float Mirror",
            price: "32,200",
            emi: "2849",
            tag: "MADE TO ORDER",
            status: "MADE TO ORDER",
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Decorative Mirrors</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="px-1 pt-2">
                                            <div className="h-0.5 bg-gray-200 relative mb-6">
                                                <div className="absolute left-[5%] right-[25%] h-full bg-black"></div>
                                                <div className="absolute left-[5%] top-1/2 -translate-y-1/2 w-4 h-4 bg-white border-2 border-black rounded-full cursor-pointer shadow-sm"></div>
...
export default DecorativeMirrorsCollection;
