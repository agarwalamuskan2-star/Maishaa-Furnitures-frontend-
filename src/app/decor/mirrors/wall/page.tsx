...
const WallMirrorsCollection = () => {
    useEffect(() => {
        document.title = "Buy Modern Wall Mirror Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Althea Jute Mirror",
            price: "25,920",
        ...
        {
            name: "Mandala Round Decorative Mirror",
            price: "27,120",
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Wall Mirrors</span>
                    </nav>
                </div>
...
export default WallMirrorsCollection;
