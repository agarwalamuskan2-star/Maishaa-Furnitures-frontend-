...
/**
 * FABRIC RACKS COLLECTION PAGE
 */

const FabricRacksCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Fabric Racks Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Minimalist Oak Quilt Rack",
            price: "12,500",
            emi: "1103",
            tag: "READY TO SHIP",
        ...
        {
            name: "Industrial Metal Blanket Ladder",
            price: "8,900",
            emi: "785",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
        ...
        {
            name: "Scandi Folding Fabric Rack",
            price: "6,400",
            tag: "SOLD OUT",
            status: "SOLD OUT",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Fabric Racks</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Racks (4)</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
export default FabricRacksCollection;
