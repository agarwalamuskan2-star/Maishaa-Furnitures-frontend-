...
/**
 * BAGS & BASKETS COLLECTION PAGE
 */

const BagsBasketsCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Bags & Baskets Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Woven Abaca Laundry Basket",
            price: "5,800",
            emi: "511",
            tag: "READY TO SHIP",
        ...
        {
            name: "Leather Bound Storage Tote",
            price: "11,200",
            emi: "987",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
        ...
        {
            name: "Nautical Rope Storage Bag",
            price: "3,500",
            tag: "SOLD OUT",
            status: "SOLD OUT",
        ...
        {
            name: "Hand-Knitted Cotton Hamper",
            price: "7,900",
            emi: "696",
            tag: "MADE TO ORDER",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="hover:text-black transition-colors">Storages</span>
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Bags & Baskets</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Baskets & Bags (4)</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
export default BagsBasketsCollection;
