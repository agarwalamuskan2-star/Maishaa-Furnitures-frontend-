...
/**
 * PENDANT LIGHTS COLLECTION PAGE
 */

const PendantLightsCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Pendant Lights Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Conical Concrete Pendant Light",
            price: "5,500",
            emi: "485",
            tag: "READY TO SHIP",
        ...
        {
            name: "Hand-Woven Rattan Pendant",
            price: "7,800",
            emi: "688",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
        ...
        {
            name: "Hammered Copper Dome Pendant",
            price: "12,900",
            tag: "SOLD OUT",
            status: "SOLD OUT",
        ...
        {
            name: "Cluster of Three Glass Pendants",
            price: "22,500",
            emi: "1985",
            tag: "MADE TO ORDER",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Pendant Lights</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Pendant Lights (4)</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
export default PendantLightsCollection;
