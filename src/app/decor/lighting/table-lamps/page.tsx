...
/**
 * TABLE LAMPS COLLECTION PAGE
 */

const TableLampsCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Table Lamps Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Sculptural Marble Table Lamp",
            price: "18,500",
            emi: "1632",
            tag: "READY TO SHIP",
        ...
        {
            name: "Hand-Thrown Ceramic Base Lamp",
            price: "9,120",
            tag: "SOLD OUT",
            status: "SOLD OUT",
        ...
        {
            name: "Glass Pillar Bedside Lamp",
            price: "14,900",
            emi: "1312",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Table Lamps</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Table Lamps (4)</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
export default TableLampsCollection;
