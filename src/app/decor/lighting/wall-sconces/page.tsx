...
/**
 * WALL SCONCES COLLECTION PAGE
 */

const WallSconcesCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Wall Sconces Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Brushed Gold Articulating Sconce",
            price: "8,500",
            emi: "750",
            tag: "READY TO SHIP",
        ...
        {
            name: "Frosted Glass Disc Sconce",
            price: "6,900",
            emi: "609",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
        ...
        {
            name: "Minimalist Vertical Tube Sconce",
            price: "11,500",
            emi: "1015",
            tag: "MADE TO ORDER",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Wall Sconces</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Wall Sconces (4)</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
export default WallSconcesCollection;
