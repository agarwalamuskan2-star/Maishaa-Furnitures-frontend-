...
/**
 * PLANTERS COLLECTION PAGE
 */

const PlantersCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Planters Online | Maishaa";
    }, []);
    ...
    const products = [
        ...
        {
            name: "Geometric Metal Pedestal Planter",
            price: "4,800",
            emi: "423",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
        ...
        {
            name: "Woven Seagrass Basket Planter",
            price: "2,200",
            tag: "SOLD OUT",
            status: "SOLD OUT",
        ...
        {
            name: "Minimalist Concrete Planter Set",
            price: "8,900",
            emi: "784",
            tag: "MADE TO ORDER",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Planters</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Planters (4)</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
export default PlantersCollection;
