...
/**
 * DECOR PIECES COLLECTION PAGE
 */

const DecorPiecesCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Decor Pieces Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Abstract Stoneware Sculpture",
            price: "8,500",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="hover:text-black transition-colors">Objects</span>
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Decor Pieces</span>
                    </nav>
                </div>
                    ...
                    <div className="max-w-[1920px] mx-auto flex flex-col lg:flex-row gap-12">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Objects (12)</span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div className="space-y-6">
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-6">
                                <p className="text-gray-900 font-medium tracking-[0.1em] text-sm uppercase">6 Results</p>
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col gap-2 pt-2 px-1">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <p className="text-[11px] text-orange-600 font-bold tracking-wider uppercase pt-1">EMI starts from ₹ {product.emi}</p>
                                            </div>
                                        </div>
                                    </motion.div>
                                ))}
...
export default DecorPiecesCollection;
