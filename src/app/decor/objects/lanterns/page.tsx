...
/**
 * LANTERNS & CANDLE HOLDERS COLLECTION PAGE
 */

const LanternsCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Lanterns & Candle Holders Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Industrial Copper Lantern",
            price: "3,800",
            emi: "335",
            tag: "READY TO SHIP",
        ...
        {
            name: "Minimalist Brass Taper Holder",
            price: "2,400",
            emi: "212",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
        ...
        {
            name: "Hand-Blown Glass Hurricane",
            price: "6,900",
            tag: "SOLD OUT",
            status: "SOLD OUT",
        ...
        {
            name: "Moroccan Gold Lantern Set",
            price: "15,500",
            emi: "1365",
            tag: "MADE TO ORDER",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Lanterns & Candle Holders</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Lanterns (4)</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
