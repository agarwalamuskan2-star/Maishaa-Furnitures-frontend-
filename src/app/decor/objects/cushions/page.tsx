...
/**
 * CUSHIONS & RUNNERS COLLECTION PAGE
 */

const CushionsCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Cushions & Runners Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Velvet Emerald Cushion",
            price: "2,500",
            emi: "220",
            tag: "READY TO SHIP",
        ...
        {
            name: "Geometric Jacquard Cushion",
            price: "1,900",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Cushions & Runners</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Cushions (4)</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
export default CushionsCollection;
