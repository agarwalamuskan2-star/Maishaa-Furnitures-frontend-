...
/**
 * BOOKENDS COLLECTION PAGE
 */

const BookendsCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Bookends Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Brutalist Concrete Bookends",
            price: "4,200",
            emi: "370",
            tag: "READY TO SHIP",
        ...
        {
            name: "Polished Travertine Bookends",
            price: "9,800",
            emi: "863",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
        ...
        {
            name: "Sculptural Horse Head Bookends",
            price: "14,900",
            emi: "1312",
            tag: "MADE TO ORDER",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Bookends</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Bookends (4)</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
export default BookendsCollection;
