...
/**
 * PAINTINGS COLLECTION PAGE
 */

const PaintingsCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Paintings Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Abstract Horizon Oil Painting",
            price: "45,000",
            emi: "3811",
            tag: "MADE TO ORDER",
        ...
        {
            name: "Textured Earth Tones Canvas",
            price: "28,400",
            emi: "2411",
            tag: "READY TO SHIP",
        ...
        {
            name: "Minimalist Ink Wash Study",
            price: "15,120",
            tag: "SOLD OUT",
            status: "SOLD OUT",
        ...
        {
            name: "Coastal Serenity Watercolor",
            price: "19,900",
            emi: "1761",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Paintings</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Paintings (4)</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
