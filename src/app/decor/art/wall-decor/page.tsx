...
/**
 * ART WALL DECOR COLLECTION PAGE
 */

const ArtWallDecorCollection = () => {
    useEffect(() => {
        document.title = "Buy Premium Art Wall Decor Online | Maishaa";
    }, []);

    const products = [
        {
            name: "Sculptural Iron Wall Relief",
            price: "24,500",
            emi: "2161",
            tag: "READY TO SHIP",
        ...
        {
            name: "Brass Constellation Wall Art",
            price: "19,900",
            emi: "1761",
            tag: "READY TO SHIP",
            status: "READY TO SHIP",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="hover:text-black transition-colors">Art</span>
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Wall Decor</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 text-gray-900 font-medium">
                                                ...
                                                <span className="text-[14px]">Wall Art (4)</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
export default ArtWallDecorCollection;
