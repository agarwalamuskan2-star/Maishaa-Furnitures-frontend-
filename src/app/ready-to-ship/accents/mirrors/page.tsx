...
/**
 * READY TO SHIP - MIRRORS COLLECTION PAGE
 */

const ReadyToShipMirrorsPage = () => {
    useEffect(() => {
        document.title = "Ready to Ship Mirrors | Maishaa";
    }, []);
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Ready to Ship Accents</span>
                    </nav>
                </div>
...
export default ReadyToShipMirrorsPage;
