...
/**
 * READY TO SHIP - SIDE TABLES
 */

const ReadyToShipSideTablesPage = () => {
    useEffect(() => {
        document.title = "Ready to Ship Side Tables | Maishaa";
    }, []);
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <Link href="/ready-to-ship/furniture" className="hover:text-black transition-colors">Furniture</Link>
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Side Tables</span>
                    </nav>
                </div>
                    ...
                    <div className="max-w-[1920px] mx-auto flex flex-col lg:flex-row gap-12">
                        ...
                        <div className="flex-1">
                            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-6">
                                <p className="text-gray-900 font-medium tracking-[0.1em] text-sm uppercase">17 Results</p>
...
export default ReadyToShipSideTablesPage;
