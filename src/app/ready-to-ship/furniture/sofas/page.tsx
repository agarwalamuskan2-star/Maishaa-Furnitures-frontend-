...
const ReadyToShipSofas = () => {
    useEffect(() => {
        document.title = "In Stock Sofas & Sectionals | Ready to Ship | Maishaa";
    }, []);

    const products: Product[] = [
        {
            name: "Lydia 3-Seater Sofa",
            price: "1,25,000",
            emi: "10,416",
            tag: "READY TO SHIP",
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">In Stock Sofas & Sectionals</span>
                    </nav>
                </div>
...
export default ReadyToShipSofas;
