...
/**
 * READY TO SHIP - FURNITURE (ALL CATEGORIES)
 */

const ReadyToShipFurniturePage = () => {
    useEffect(() => {
        document.title = "Ready to Ship Furniture | Maishaa";
    }, []);

    const products = [
        {
            name: "Rigo Solid Wood Coffee Table",
            price: "99,900",
            originalPrice: "1,11,000",
            emi: "10474",
            tag: "READY TO SHIP",
        ...
        {
            name: "Thalika Coffee Table & End Table - Set of 2",
            price: "1,43,920",
            ...
            <main className="flex-1">
                ...
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">Ready to Ship Furniture</span>
                    </nav>
                </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <ul className="space-y-3">
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                ...
                                                <span className="text-[14px]">Side Table (17)</span>
                                            </li>
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                <div className="w-4 h-4 border border-gray-300 rounded-sm"></div>
                                                <span className="text-[14px]">Dining Chairs (15)</span>
                                            </li>
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                <div className="w-4 h-4 border border-gray-300 rounded-sm"></div>
                                                <span className="text-[14px]">Outdoor Furniture (11)</span>
                                            </li>
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                <div className="w-4 h-4 border border-gray-300 rounded-sm"></div>
                                                <span className="text-[14px]">Center Tables (10)</span>
                                            </li>
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                <div className="w-4 h-4 border border-gray-300 rounded-sm"></div>
                                                <span className="text-[14px]">Accent | Lounge Chairs (10)</span>
                                            </li>
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                <div className="w-4 h-4 border border-gray-300 rounded-sm"></div>
                                                <span className="text-[14px]">0 (8)</span>
                                            </li>
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                <div className="w-4 h-4 border border-gray-300 rounded-sm"></div>
                                                <span className="text-[14px]">Benches (3)</span>
                                            </li>
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                <div className="w-4 h-4 border border-gray-300 rounded-sm"></div>
                                                <span className="text-[14px]">Decor (2)</span>
                                            </li>
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                <div className="w-4 h-4 border border-gray-300 rounded-sm"></div>
                                                <span className="text-[14px]">Console Tables (2)</span>
                                            </li>
                                            <li className="flex items-center gap-3 group cursor-pointer text-gray-500 hover:text-black transition-colors">
                                                <div className="w-4 h-4 border border-gray-300 rounded-sm"></div>
                                                <span className="text-[14px]">Lounge Chairs (1)</span>
                                            </li>
                                        </ul>
                                        <button className="text-[13px] text-gray-500 hover:text-black font-medium transition-colors">
                                            More
                                        </button>
                                    </div>
...
export default ReadyToShipFurniturePage;
