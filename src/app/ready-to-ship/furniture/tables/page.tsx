...
const ReadyToShipTables = () => {
    useEffect(() => {
        document.title = "In Stock Tables | Ready to Ship | Maishaa";
    }, []);
    ...
    const availableTypes = [
        ...
        { label: "End Tables", value: "End Tables", count: products.filter(p => p.type === "End Tables").length }
    ].filter(t => t.count > 0);
            ...
            <main className="flex-1">
                <div className="pt-6 pb-4 px-4 sm:px-8 md:px-16 lg:px-20 bg-white border-b border-gray-50">
                    <nav className="flex items-center gap-2 text-gray-400 text-[11px] tracking-wide uppercase">
                        ...
                        <ChevronRight size={12} />
                        <span className="text-black font-semibold">In Stock Tables</span>
                    </nav>
                </div>
...
export default ReadyToShipTables;
