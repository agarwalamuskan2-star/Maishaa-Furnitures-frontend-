...
export default function OutdoorSEOContent() {
    return (
        <section className="bg-gray-50 py-16 sm:py-20">
            <div className="max-w-[1920px] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 text-center">
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    <div className="text-left">
                        <h3 className="text-xl font-serif text-gray-900 mb-4">Why Is Outdoor Furniture Important?</h3>
                        ...
                        <ul className="space-y-6">
                            <li>
                                <h4 className="font-bold text-gray-800 text-sm mb-1">Aesthetic Appeal:</h4>
                            ...
                            <li>
                                <h4 className="font-bold text-gray-800 text-sm mb-1">Comfort and Relaxation:</h4>
                                <p className="text-sm text-gray-600 font-light">
                            ...
                            <li>
                                <h4 className="font-bold text-gray-800 text-sm mb-1">Social Gathering:</h4>
                                <p className="text-sm text-gray-600 font-light">
                            ...
                            <li>
                                <h4 className="font-bold text-gray-800 text-sm mb-1">Maximising Outdoor Space:</h4>
                                <p className="text-sm text-gray-600 font-light">
                            ...
                            <li>
                                <h4 className="font-bold text-gray-800 text-sm mb-1">Enhancing Well-Being:</h4>
                                <p className="text-sm text-gray-600 font-light">
